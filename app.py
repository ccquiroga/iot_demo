...
class Index:
    conn = pymysql.connect(host="wp433upk59nnhpoh.cbetxkdyhwsb.us-east-1.rds.amazonaws.com", port=3306, user="nwc6tssdqmori2cr", passwd="t6ifbjox2d6t2d5y", db="wqx02vtt7ocg0htb")
    cur = conn.cursor()
